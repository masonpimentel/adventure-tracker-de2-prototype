...
void DrawTripLabels()
{
	...
	DrawString(60, 275, "Total Distance (km): ", sizeof("Total Distance (km): ")-1,BLACK, GRAY);
	DrawString(60, 345, "Total Change in Altitude (m): ", sizeof("Total Change in Altitude (m): ")-1,BLACK, GRAY);
}
