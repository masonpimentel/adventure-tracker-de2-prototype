...
void DrawGpsLabels()
{
	...
	DrawString(200, 90, "Current Trip: ", sizeof("Current Trip: ")-1, NAVY, GRAY);
}

/*
 * Draws the data in New Trip, including current location information and the status of the mode buttons
 */
...
void DrawGpsMenu(int *redraw)
{
	...
	DrawButton(62, 80, 162, 130, "Log POI", strlen("Log POI"), WHITE, BLUE);
